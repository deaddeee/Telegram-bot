...
async def cmd_start(message: types.Message):
    await message.reply(
        "Привет! Это Бот для конвертации голосового/аудио сообщения в текст. Запиши мне голосовое сообщение или перешли голосовое сообщение из другого чата, я с радостью переведу его в текст!"
    )
...
async def voice_message_handler(message: types.Message):
    ...
    await message.reply("Аудиосообщение получено, сейчас переведу в текстовый формат")
